...
public class AddStudent extends JFrame implements ActionListener{
    ...
    AddStudent() {
        ...
        lblrollno.setBounds(50, 170, 200, 30);
        lblrollno.setFont(new Font("serif", Font.BOLD, 20));
        add(lblrollno);
        
        labelrollno = new JLabel("1533"+first4);
        labelrollno.setBounds(200, 170, 200, 30);
        labelrollno.setFont(new Font("serif", Font.BOLD, 20));
        add(labelrollno);
        
        JLabel lbldob = new JLabel("Date of Birth");
        lbldob.setBounds(400, 170, 170, 30);
        ...
        lbladdress.setBounds(50, 220, 200, 30);
        ...
        lblphone.setBounds(400, 220, 200, 30);
        ...
        lblemail.setBounds(50, 270, 200, 30);
        ...
        lblxii.setBounds(50, 320, 200, 30);
        ...
        lblbranch.setBounds(400, 370, 200, 30);
